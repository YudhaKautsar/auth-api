...
describe('/users endpoint', () => {
  ...
  describe('when POST /users', () => {
    ...
    it('should response 400 when request payload not containe needed property', async () => {
      // Arrange
      const requestPayload = {
        fullname: 'Dicoding Indonesia',
        password: 'secret'
    ...
    it('should response 400 when username more than 50 character', async () => {
      // Arrange
      const requestPayload = {
        username: 'dicodingnjagangjajgnagnsjgsnjgjibSUHBsigwijgwGNWKNGWNGKWQENGKWBGKWBGKGK3NGI3NVIENVIENBGVKJEBNVIKEBVIEQLBVIEIVQBVGIBVGIWBVG',
        password: 'secret',
        fullname: 'Dicoding Indonesia'
      }
